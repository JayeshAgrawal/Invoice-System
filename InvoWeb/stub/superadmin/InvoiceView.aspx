<%@ Page Title="" Language="C#" MasterPageFile="~/superadmin/supermain.master" AutoEventWireup="true" CodeFile="InvoiceView.aspx.cs" Inherits="companyadmin_InvoiceView" %>
...
<div id="print">
   ...
   <asp:GridView ID="gvItem" runat="server" AutoGenerateColumns="False" 
    CssClass="mGrid"  
     ...
     <Center>InvoiceDesign By <a href="#">InvoWebStub</a></Center>
    </asp:Panel>
 </div>
     </fieldset>
</div>  
