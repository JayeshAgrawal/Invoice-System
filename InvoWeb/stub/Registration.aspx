...
<td>
    <asp:TextBox ID="txtUserName" runat="server" CssClass="text" MaxLength="10" ></asp:TextBox>
</td>
<td>&nbsp;</td>
</tr>
<tr>
...
<td>
    <asp:TextBox ID="txtCompanyName" runat="server" CssClass="text" 
        ValidationGroup="s" MaxLength="10"></asp:TextBox>
</td>
<td>&nbsp;</td>
</tr>
...
<td>
    <asp:TextBox ID="txtInvoiceNoPrefix" runat="server" CssClass="text" 
        ValidationGroup="s" MaxLength="3"></asp:TextBox><br /> example. "IWS" for InvoiceNo-"IWS00002". 
</td>
...
<td>
    <asp:TextBox ID="txtContactNo" runat="server" CssClass="text" 
        ValidationGroup="s" MaxLength="13"></asp:TextBox>
</td>
<td>
    &nbsp;</td>
</tr>
