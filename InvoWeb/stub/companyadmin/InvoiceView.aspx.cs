...
public partial class companyadmin_InvoiceView : System.Web.UI.Page
{
    ...
    protected void btnEmail_Click(object sender, EventArgs e)
    {
        string Mail_body = "<h3> Company Name: " + lblCompName.Text + "</h3><br /> Invoice No: " + lblInvoiceNo.Text
            + "<br /> <h4>Invoice Date: " + lblInvoiceDate.Text + "<br />Customer Name: " + lblCustName.Text +"</h4><br /><br />" + GridViewToHtml(gvItem) + "<br /> SubTotalAmount(Rs.): "
            ...
            + "<br /><br /><h3>Grand Total Amount: " + lblTotalAmount.Text + "</h3><br /><br />";
