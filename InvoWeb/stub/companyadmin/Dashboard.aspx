...
<td width="280px" align="center">
  ...
  <asp:DataList ID="dlItem" runat="server" BackColor="White" 
    ...
    <asp:SqlDataSource ID="SqlDataSource7" runat="server" 
        ...
        SelectCommand="SELECT InvoiceDetail.ItemName, SUM(InvoiceDetail.Quantity) AS NoSale FROM InvoiceMaster INNER JOIN InvoiceDetail ON InvoiceMaster.InvoiceId = InvoiceDetail.InvoiceId WHERE (InvoiceMaster.CompanyId = @CompanyId) GROUP BY InvoiceDetail.ItemName ORDER BY NoSale DESC">
        <SelectParameters>
            <asp:SessionParameter Name="CompanyId" SessionField="CompanyId" 
                Type="Decimal" />
        </SelectParameters>
...
<h2>Daily Sales Performance</h2>
    <asp:Chart ID="Chartdaily" runat="server" BackColor="" 
        ...
        <series>
            <asp:Series Name="Series1" XValueMember="CreatedDate" 
                YValueMembers="TotalAmount" ChartType="FastLine" YValuesPerPoint="6" >
            </asp:Series>
        </series>
        <chartareas>
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ...
        SelectCommand="SELECT CreatedDate, SUM(NetAmount) AS TotalAmount FROM InvoiceMaster WHERE (CompanyId = @CompanyId) GROUP BY CreatedDate ORDER BY CreatedDate" 
        >
        <SelectParameters>
            <asp:SessionParameter Name="CompanyId" SessionField="CompanyId" 
                Type="Decimal" />
