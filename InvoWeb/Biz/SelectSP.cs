   ...
   public class SelectSP
    {
       ...
       #region Select_UserInfo..

       public DataTable Select_UserInfo(UserMaster _user)
       {
           SqlParameter[] param ={   new SqlParameter("@UserId", _user.UserId),
                                };
           return _da.GetFromDataTable("Select_UserInfo", param);
       }
       #endregion
